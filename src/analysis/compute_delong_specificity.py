...
For each recovery set (immune-exclusive, cardiac-exclusive), on that set's shared case pool:
  - our_model vs OT_genetic_immune
  - our_model vs OT_genetic_cardiac
  - OT_genetic_immune vs OT_genetic_cardiac (diagonal-dominance check, not drawn)
